...
description: >
  Archive knowledge to GitHub Issues. Use when user requests
...
| Keyword                                       | Reference File                          | Title Prefix     |
| --------------------------------------------- | --------------------------------------- | ---------------- |
| `til`, `today i learned`, `学到了`            | `reference/today-i-learned.md`          | `[Til]`          |
| `how-to`, `howto`, `指南`                     | `reference/how-to-template.md`          | `[How-To]`       |
| `cheatsheet`, `速查`, `备忘`                  | `reference/cheatsheet-template.md`      | `[Cheatsheet]`   |
| `snippets`, `代码片段`, `snippet`             | `reference/snippets-template.md`        | (none)           |
| `troubleshoot`, `故障排除`, `troubleshooting` | `reference/troubleshoot-template.md`    | `[Troubleshoot]` |

Refer to the corresponding file under `reference/` for each template's fields and body structure.
...
- Ask targeted questions based on the template's required fields (see `reference/`)
...
- Construct body following the template structure from the corresponding `reference/` file
